...
#ifndef DRIVERS_CSS_CSS_H
#define DRIVERS_CSS_CSS_H
 ...
 */
uint8_t constfn css_get_cluster_count(void);
 ...
 * @param cluster The index of the cluster.
 */
uint8_t constfn css_get_core_count(uint8_t cluster);
